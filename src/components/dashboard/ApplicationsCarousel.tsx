...
const ApplicationsTable: React.FC<ApplicationsTableProps> = ({
  ...
  return (
    <div className="bg-white dark:bg-gray-800 rounded-lg shadow-sm relative">        {/* Navigation Controls - Outside carousel, full left and right */}
      {filteredApplications.length > 3 && (
        <>
          <button
            onClick={scrollLeft}
            disabled={currentIndex === 0}
            className="absolute -left-16 top-1/2 transform -translate-y-1/2 z-20 bg-white dark:bg-gray-700 shadow-lg rounded-full p-3 hover:shadow-xl transition-all disabled:opacity-50 disabled:cursor-not-allowed border border-gray-200 dark:border-gray-600"
          >
          ...
          <button
            ...
            className="absolute -right-16 top-1/2 transform -translate-y-1/2 z-20 bg-white dark:bg-gray-700 shadow-lg rounded-full p-3 hover:shadow-xl transition-all disabled:opacity-50 disabled:cursor-not-allowed border border-gray-200 dark:border-gray-600"
          >
      ...
      <div className="p-6 border-b border-gray-200 dark:border-gray-700">
        <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
          ...
          <div className="flex flex-col sm:flex-row gap-3 w-full sm:w-auto">
            ...
            <div className="relative">
              <Filter className="absolute left-3 top-1/2 transform -translate-y-1/2 text-gray-400" size={16} />              <select
                value={statusFilter}
